...
gulp.task('t0082', (callback) => {
  require('./task0082-sorted-list-del-dups-2/sorted-list-del-dups-2.js')(callback);
});
...
gulp.task('t0095', (callback) => {
  require('./task0095-unique-bst-2/unique-bst-2.js')(callback);
});
...
gulp.task('t0100', (callback) => {
  require('./task0100-same-tree/same-tree.js')(callback);
});
