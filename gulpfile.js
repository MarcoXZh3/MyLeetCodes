...
gulp.task('t0139', (callback) => {
  require(path.resolve('task0139-word-break/word-break.js'))(callback);
});
...
gulp.task('t0143', (callback) => {
  require(path.resolve('task0143-reorder-list/reorder-list.js'))(callback);
});
gulp.task('t0144', (callback) => {
  require(path.resolve('task0144-bin-tree-preorder/bin-tree-preorder.js'))(callback);
});
gulp.task('t0145', (callback) => {
  require(path.resolve('task0145-bin-tree-postorder/bin-tree-postorder.js'))(callback);
});
...
gulp.task('t0153', (callback) => {
  require(path.resolve('task0153-rotate-sort-arr-min/rotate-sort-arr-min.js'))(callback);
});
...
gulp.task('t0159', (callback) => {
  require(path.resolve('task0159-max-sub-two-dists/max-sub-two-dists.js'))(callback);
});
...
gulp.task('t0163', (callback) => {
  require(path.resolve('task0163-miss-ranges/miss-ranges.js'))(callback);
});
...
gulp.task('t0170', (callback) => {
  require(path.resolve('task0170-two-sum-3/two-sum-3.js'))(callback);
});
...
gulp.task('t0176', (callback) => {
  console.log(fs.readFileSync(path.resolve('task0176-2nd-high-salary/2nd-high-salary.sql')).toString());callback();
});
gulp.task('t0177', (callback) => {
  console.log(fs.readFileSync(path.resolve('task0177-nth-high-salary/nth-high-salary.sql')).toString());callback();
});
...
gulp.task('t0181', (callback) => {
  console.log(fs.readFileSync(path.resolve('task0181-employess-earn/employee-earn.sql')).toString());callback();
});
gulp.task('t0182', (callback) => {
  console.log(fs.readFileSync(path.resolve('task0182-dup-emails/dup-emails.sql')).toString());callback();
});
gulp.task('t0183', (callback) => {
  console.log(fs.readFileSync(path.resolve('task0183-cust-no-orders/cust-no-orders.sql')).toString());callback();
});
gulp.task('t0184', (callback) => {
  console.log(fs.readFileSync(path.resolve('task0184-dept-high-salary/dept-high-salary.sql')).toString());callback();
});
...
gulp.task('t0188', (callback) => {
  require(path.resolve('task0188-buy-sell-stock-4/buy-sell-stock-4.js'))(callback);
});
gulp.task('t0189', (callback) => {
  require(path.resolve('task0189-rotate-array/rotate-array.js'))(callback);
});
...
gulp.task('t0195', (callback) => {
  chp.exec(`sh ${path.resolve('task0195-10th-line/10th-line.sh')}`, (e,o)=>{ console.log(e||o); callback(e) });
});
